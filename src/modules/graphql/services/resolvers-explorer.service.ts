...
import { ResolverContextCreator } from '../resolver/resolver-context-creator';
...
export class ResolversExplorerService {
  private readonly resolverContextCreator: ResolverContextCreator;
  constructor(
    private readonly modulesContainer: ModulesContainer,
    private readonly metadataScanner: MetadataScanner,
    private readonly externalContextCreator: ExternalContextCreator
  ) {
    this.resolverContextCreator = ResolverContextCreator.fromExternalContextCreator(externalContextCreator);
  }
  ...
  filterResolvers(instance: Injectable): ResolverMetadata[] {
    ...
    return resolvers.filter(resolver => !!resolver).map(resolver => {
      ...
      const resolverCallback = this.resolverContextCreator.create(
        instance,
